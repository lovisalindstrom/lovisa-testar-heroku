...
public class MediaPlayer
{
    ...
    {
        android.util.Log.d("FbTest", (message==null ? "null" : message.toString()));
    }
    ...
    {
        android.view.Window window = com.apps.fbtest.FbTest.GetRootActivity().getWindow();
        			...
        			try
        			{
        				android.content.pm.ActivityInfo info = com.apps.fbtest.FbTest.GetRootActivity().getPackageManager().getActivityInfo(com.apps.fbtest.FbTest.GetRootActivity().getComponentName(), 0);
    ...
    public static void Pause1220(final Object handle)
    {
        android.media.MediaPlayer player = (android.media.MediaPlayer)handle;
        			if (player.isPlaying())
        			{
        				android.media.AudioManager am = (android.media.AudioManager)com.apps.fbtest.FbTest.GetRootActivity().getSystemService(android.content.Context.AUDIO_SERVICE);
