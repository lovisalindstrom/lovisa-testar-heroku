...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/fbtest/FbTest");
    jclass entryPointsClass = env->FindClass("com/apps/fbtest/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/fbtest/Display");
