...
//    #endif
    {
        return com.apps.fbtest.FbTest.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.fbtest.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.fbtest.FbTest activity = (com.apps.fbtest.FbTest)getRootActivity();
