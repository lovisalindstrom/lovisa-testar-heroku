...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/$.uno
// ------------------------------------------------------------------------------------
...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Android/0.42.2/$.uno
// ----------------------------------------------------------------------------------------
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/$.uno");
...
void Binding::Root(::g::Fuse::Node* parent)
{
    ...
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"/Users/malm...*/], 448, ::STRINGS[4/*"Root"*/]);
...
void Binding::Unroot()
{
    ...
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"/Users/malm...*/], 457, ::STRINGS[6/*"Unroot"*/]);
...
static void Deferred_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.42.2/$.uno");
...
void Deferred__FuseIDeferredPerform_fn(Deferred* __this)
{
    ...
    if (__this->_added != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"Duplicate c...*/], __this, ::STRINGS[9/*"/Users/malm...*/], 581, ::STRINGS[10/*"Fuse.IDefer...*/]);
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 936, ::STRINGS[26/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 1075, ::STRINGS[27/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 993, ::STRINGS[35/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 1116, ::STRINGS[36/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 1160, ::STRINGS[37/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 1037, ::STRINGS[28/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/malm...*/], 1022, ::STRINGS[29/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    ...
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Sc...*/], this, ::STRINGS[3/*"/Users/malm...*/], 953, ::STRINGS[31/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[32/*"Unpopped Cu...*/], this, ::STRINGS[3/*"/Users/malm...*/], 957, ::STRINGS[31/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[33/*"Unpopped Vi...*/], this, ::STRINGS[3/*"/Users/malm...*/], 961, ::STRINGS[31/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[34/*"Unpopped Re...*/], this, ::STRINGS[3/*"/Users/malm...*/], 965, ::STRINGS[31/*"ReleaseRoot...*/]);
...
static void DrawHelpers_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[36/*float2[]*/], offsetof(::g::Fuse::DrawHelpers, DrawLocalRect_Vertices_1e24cb92_1_1_4), 0,
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[44/*"GraphicsWor...*/], e, a, ::STRINGS[3/*"/Users/malm...*/], 2891, ::STRINGS[45/*"Run"*/]);
...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/resources/$.uno
// ----------------------------------------------------------------------------------------------
...
LayoutParams LayoutParams::DeriveClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[47/*"Use CloneAn...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"/Users/malm...*/], 3408, ::STRINGS[48/*"DeriveClone"*/]);
...
LayoutParams LayoutParams::TrueClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[49/*"Use Clone i...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"/Users/malm...*/], 3379, ::STRINGS[50/*"TrueClone"*/]);
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[69] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.42.2/$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"UserEvent r...*/], __this, ::STRINGS[69/*"/Users/malm...*/], 638, ::STRINGS[70/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[73/*"Trying to R...*/], this, ::STRINGS[69/*"/Users/malm...*/], 685, ::STRINGS[74/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[71/*"Raise must ...*/], n, ::STRINGS[69/*"/Users/malm...*/], 421, ::STRINGS[67/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[72/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[69/*"/Users/malm...*/], 428, ::STRINGS[67/*"raise"*/]);
        return;
    }
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[75/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[69/*"/Users/malm...*/], 698, ::STRINGS[76/*"RaiseEvent"*/]);
        return;
    }
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[85/*"Invalid Rai...*/], 1, ::STRINGS[3/*"/Users/malm...*/], 2127);
            return;
        }
    }
