...
//#else
public class FbTest extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	FbTest activity = _appState.CurrentActivity;
...
//#endif
    ...
    public static FbTest RootActivity()
    {
        return _appState.CurrentActivity;
    }
