// This file was generated based on /Users/malmgren/Documents/PublicKnowledge/FbTest/build/Android/Preview/preamble/$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("77.238.48.55");
    ::STRINGS[2] = uString::Const("/Users/malmgren/Documents/PublicKnowledge/FbTest/FbTest.unoproj");
    ::STRINGS[3] = uString::Const("FbTest");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"FbTest"*/]);
}
