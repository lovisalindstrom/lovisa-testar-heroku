...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.33.127"), 12124)}, "/Users/malmgren/Desktop/FbTest/FbTest.unoproj", GetBundle, new string[] { })
{
