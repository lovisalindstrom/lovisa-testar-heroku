#!/bin/bash
# This file was generated based on '/Users/malmgren/Library/Application Support/Fusetools/Packages/UnoCore/0.42.3/targets/ios/build.sh'.
...
##else
    xcodebuild -project "FbTest.xcodeproj" "$@" | tee >(checkForError)
##endif
