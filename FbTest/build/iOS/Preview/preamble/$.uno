...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("77.238.48.55"), 12124)}, "/Users/malmgren/Documents/PublicKnowledge/FbTest/FbTest.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("FbTest");
}
}
}
