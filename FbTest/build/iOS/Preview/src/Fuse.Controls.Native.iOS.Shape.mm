...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.42.2/ios/$.uno");
...
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, uObject* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/Users/malm...*/], 2214, ::STRINGS[2/*"SetBrush"*/]);
