...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.42.2/ios/$.uno
// -----------------------------------------------------------------------------------------------------
...
static void WebView_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.42.2/ios/$.uno");
...
void WebView::OnLowMemory()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"low mem in ...*/], 1, ::STRINGS[3/*"/Users/malm...*/], 225);
