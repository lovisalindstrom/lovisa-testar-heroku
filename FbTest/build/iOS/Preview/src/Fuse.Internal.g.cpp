...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/internal/$.uno
// ---------------------------------------------------------------------------------------------
...
static void Cache_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Fuse::Internal::CacheRef_typeof();
    ::TYPES[8] = ::g::Fuse::Internal::CacheItem_typeof();
    type->SetPrecalc(
    ...
    type->SetInterfaces(
        ::TYPES[6/*Uno.IDisposable*/], offsetof(Cache_type, interface0));
    type->SetFields(0,
        ::TYPES[5/*Uno.Collections.Dictionary`2*/]->MakeType(type->T(0), ::TYPES[7/*Fuse.Internal.CacheRef`2*/]->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(::g::Fuse::Internal::Cache, _dict), 0,
        ...
        ::TYPES[4/*Uno.Collections.LinkedList`1*/]->MakeType(::TYPES[7/*Fuse.Internal.CacheRef`2*/]->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(::g::Fuse::Internal::Cache, _unused), 0);
    type->Reflection.SetFunctions(3,
        new uFunction("Dispose", NULL, (void*)Cache__Dispose_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("Get", NULL, (void*)Cache__Get_fn, 0, false, ::TYPES[8/*Fuse.Internal.CacheItem`2*/]->MakeType(type->T(0), type->T(1), NULL), 1, type->T(0)),
...
static void CacheRef_build(uType* type)
{
    ::TYPES[6] = ::g::Uno::IDisposable_typeof();
    type->SetInterfaces(
        ::TYPES[6/*Uno.IDisposable*/], offsetof(CacheRef_type, interface0));
    type->SetFields(0,
...
void CacheRef::Dispose()
{
    ...
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(Value), ::TYPES[6/*Uno.IDisposable*/]));
}
...
{
    ::TYPES[9] = ::g::Fuse::Internal::MiniList_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(0,
        ::TYPES[9/*Fuse.Internal.MiniList`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Internal::MiniList__Enumerator, _source), 0,
...
{
    ::TYPES[10] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::String_typeof()->Array();
    ::TYPES[12] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(10/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Int_typeof();
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[17] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(0/*All<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::UX::FileSource_typeof(), offsetof(::g::Fuse::Internal::FontFaceDescriptor, FileSource), 0,
        ::TYPES[13/*int*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Index), 0,
        ::TYPES[14/*Uno.Collections.IEnumerable<string>*/], offsetof(::g::Fuse::Internal::FontFaceDescriptor, Styles), 0);
}
...
void FontFaceDescriptor__Equals_fn(FontFaceDescriptor* __this, uObject* o, bool* __retval)
{
    ...
    return *__retval = (((f != NULL) && ::g::Uno::String::op_Equality(uPtr(__this->FileSource)->Name, uPtr(uPtr(f)->FileSource)->Name)) && (__this->Index == uPtr(f)->Index)) && ::g::Uno::Collections::EnumerableExtensions::SequenceEqual(::TYPES[12/*Uno.Collections.EnumerableExtensions.SequenceEqual<string>*/], __this->Styles, uPtr(f)->Styles), void();
}
...
void FontFaceDescriptor__GetHashCode_fn(FontFaceDescriptor* __this, int* __retval)
{
    ...
    hash = (hash * 23) + ::g::Uno::Int::GetHashCode((ind1 = __this->Index, ind1), ::TYPES[13/*int*/]);

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Styles), ::TYPES[14/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[15/*Uno.Collections.IEnumerator*/])); )
    {
        uString* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[16/*Uno.Collections.IEnumerator<string>*/]), &ret5), ret5);
...
void FontFaceDescriptor::ctor_(::g::Uno::UX::FileSource* fileSource, int index)
{
    ...
    Index = index;
    Styles = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], uArray::New(::TYPES[11/*string[]*/], 0)));
}
...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.42.2/internal/$.uno
// --------------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.42.2/internal/$.uno");
    ::STRINGS[4] = uString::Const("set_ResampleMode");
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[20] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ...
    ::TYPES[25] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::EventHandler_typeof();
    ::TYPES[28] = ::g::Fuse::Resources::ImageSourceErrorHandler_typeof();
    ::TYPES[29] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[30] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[30/*Uno.Collections.ObservableList<Uno.UX.FileSource>*/], offsetof(::g::Fuse::Internal::ImageContainer, _files), 0,
        ...
        ::TYPES[21/*Fuse.Internal.IImageContainerOwner*/], offsetof(::g::Fuse::Internal::ImageContainer, _owner), uFieldFlagsWeak,
        ...
        ::TYPES[27/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, ParamChanged1), 0,
        ::TYPES[27/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceChanged1), 0,
        ::TYPES[28/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceError1), 0);
}
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[2/*"ResampleMod...*/], this, ::STRINGS[3/*"/Users/malm...*/], 255, ::STRINGS[4/*"set_Resampl...*/]);
...
static void MiniList_build(uType* type)
{
    ...
    ::TYPES[33] = MiniList__Enumerator_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[34] = ::g::Uno::Collections::LinkedList_typeof()->MakeType(::g::Fuse::Internal::SkylineNode_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[34/*Uno.Collections.LinkedList<Fuse.Internal.SkylineNode>*/], offsetof(::g::Fuse::Internal::RectPacker, _skyline), 0,
...
void RectPacker::ctor_(::g::Uno::Int2 size)
{
    ...
    Size(size);
    _skyline = ((::g::Uno::Collections::LinkedList*)::g::Uno::Collections::LinkedList::New1(::TYPES[34/*Uno.Collections.LinkedList<Fuse.Internal.SkylineNode>*/]));
...
::g::Uno::Collections::List* SystemFont::Get(uString* family, int style, int weight)
{
    ...
    return ::g::Fuse::Internal::iOSSystemFont::Get(::g::Uno::String::op_Equality(family, NULL) ? uCast<uString*>(NULL, ::TYPES[35/*string*/]) : (uString*)::g::Uno::String::ToLower(uPtr(family)), style, weight);
}
