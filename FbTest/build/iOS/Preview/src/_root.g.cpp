...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Android/0.42.2/.uno/package
// -----------------------------------------------------------------------------------------------
...
{
    FuseReactive_bundle::es6promisemin86904b6e_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[153/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[154/*"es6-promise...*/]);
    FuseReactive_bundle::Observabled96a5ca0_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[153/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[155/*"observable-...*/]);
    FuseReactive_bundle::setTimeoutadef4226_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[153/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[156/*"settimeout-...*/]);
}
