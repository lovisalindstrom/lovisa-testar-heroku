...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.42.2/triggers/actions/$.uno
// ----------------------------------------------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.42.2/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[7/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[8/*"/Users/malm...*/], 240, ::STRINGS[9/*"Perform"*/]);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.42.2/$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Requires a ...*/], __this, ::STRINGS[11/*"/Users/malm...*/], 285, ::STRINGS[9/*"Perform"*/]);
        return;
    }
...
static void TriggerAction_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.42.2/actions/$.uno");
...
{
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[13/*"Use `Trigge...*/], this, ::STRINGS[14/*"/Users/malm...*/], 853, ::STRINGS[15/*"set_Direction"*/]);
    When(value);
}
