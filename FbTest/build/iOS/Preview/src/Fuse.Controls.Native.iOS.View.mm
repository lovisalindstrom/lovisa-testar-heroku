// This file was generated based on '/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.42.2/ios/$.uno'.
...
{
    ::STRINGS[0] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.42.2/ios/$.uno");
...
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[0/*"/Users/malm...*/], 3544, ::STRINGS[1/*"set_Backgro...*/]);
    }
