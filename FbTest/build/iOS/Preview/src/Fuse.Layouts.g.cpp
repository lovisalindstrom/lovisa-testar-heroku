...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/0.42.2/layouts/$.uno
// --------------------------------------------------------------------------------------------------------
...
// protected DefinitionBase(Fuse.Layouts.DefinitionBase copy, Fuse.Layouts.DefinitionBase.CreationType creation) :803
...
// protected DefinitionBase(Fuse.Layouts.DefinitionBase copy, Fuse.Layouts.DefinitionBase.CreationType creation) [instance] :803
...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/0.42.2/layouts/$.uno");
...
void GridLayout::ModifyCount(uType* __type, uObject* list, int count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"RowCount an...*/], this, ::STRINGS[6/*"/Users/malm...*/], 1119, ::STRINGS[7/*"ModifyCount"*/]);
        return;
    }
