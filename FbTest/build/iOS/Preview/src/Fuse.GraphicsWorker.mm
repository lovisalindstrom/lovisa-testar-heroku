// This file was generated based on '/Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/$.uno'.
...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/$.uno");
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[1/*"GraphicsWor...*/], e, a, ::STRINGS[2/*"/Users/malm...*/], 2891, ::STRINGS[3/*"Run"*/]);
