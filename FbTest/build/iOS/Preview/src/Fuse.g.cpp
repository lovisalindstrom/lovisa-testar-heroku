...
LayoutParams LayoutParams::DeriveClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[44/*"Use CloneAn...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"/Users/malm...*/], 3408, ::STRINGS[45/*"DeriveClone"*/]);
...
LayoutParams LayoutParams::TrueClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[46/*"Use Clone i...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"/Users/malm...*/], 3379, ::STRINGS[47/*"TrueClone"*/]);
...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.iOS/0.42.2/$.uno
// ------------------------------------------------------------------------------------
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[66] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.42.2/$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[65/*"UserEvent r...*/], __this, ::STRINGS[66/*"/Users/malm...*/], 638, ::STRINGS[67/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[70/*"Trying to R...*/], this, ::STRINGS[66/*"/Users/malm...*/], 685, ::STRINGS[71/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Raise must ...*/], n, ::STRINGS[66/*"/Users/malm...*/], 421, ::STRINGS[64/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[69/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[66/*"/Users/malm...*/], 428, ::STRINGS[64/*"raise"*/]);
        return;
    }
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[72/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[66/*"/Users/malm...*/], 698, ::STRINGS[73/*"RaiseEvent"*/]);
        return;
    }
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[82/*"Invalid Rai...*/], 1, ::STRINGS[3/*"/Users/malm...*/], 2127);
            return;
        }
    }
