...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Scripting.JavaScriptCore/0.42.2/$.uno
// ---------------------------------------------------------------------------------------------------------
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Scripting.JavaScriptCore/0.42.2/$.uno");
    ::TYPES[16] = uObject_typeof()->Array();
    ::TYPES[18] = ::g::Uno::IDisposable_typeof();
...
::JSObjectRef JSValueRef::GetJSObjectRef(::JSValueRef __this, ::JSContextRef ctx)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JSValueRef::IsObject(__this, ctx), ::STRINGS[21/*"(&this).IsO...*/], ::STRINGS[22/*"/Users/malm...*/], 474, uArray::Init<uObject*>(::TYPES[16/*object[]*/], 1, uBox(::g::Fuse::Scripting::JavaScriptCore::JSContextRef_typeof(), ctx)));
