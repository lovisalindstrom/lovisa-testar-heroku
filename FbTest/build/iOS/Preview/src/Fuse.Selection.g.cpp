...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Selection/0.42.2/$.uno
// ------------------------------------------------------------------------------------------

// public sealed class Deselected :265
// {
...
// public generated Deselected() :265
void Deselected__ctor_6_fn(Deselected* __this)
{
    __this->ctor_6();
}

// protected override sealed bool IsTriggered(bool on) :267
...
// public generated Deselected New() :265
void Deselected__New2_fn(Deselected** __retval)
{
    *__retval = Deselected::New2();
}

// public generated Deselected() [instance] :265
void Deselected::ctor_6()
{
    ctor_5();
}

// public generated Deselected New() [static] :265
...
// private enum Selection.How :724
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/Fuse.Selection/0.42.2/$.uno");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 98, ::STRINGS[9/*"OnRooted"*/]);
}
...
void Selectable::Add1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/malm...*/], 139, ::STRINGS[7/*"Add"*/]);
        return;
    }
...
// public void Remove() [instance] :149
void Selectable::Remove1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/malm...*/], 153, ::STRINGS[11/*"Remove"*/]);
        return;
    }
...
// public void Toggle() [instance] :163
void Selectable::Toggle()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/malm...*/], 167, ::STRINGS[13/*"Toggle"*/]);
        return;
    }
...
// public string get_Value() [instance] :117
uString* Selectable::Value()
{
    return _value;
}

// public void set_Value(string value) [instance] :118
...
void Selectable::add(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"add require...*/], s, ::STRINGS[5/*"/Users/malm...*/], 30, ::STRINGS[1/*"add"*/]);
        return;
    }
...
void Selectable::remove(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"remove requ...*/], s, ::STRINGS[5/*"/Users/malm...*/], 48, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selectable::toggle(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/malm...*/], 64, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
// public sealed class Selected :254
// {
...
// public generated Selected() :254
void Selected__ctor_6_fn(Selected* __this)
{
    __this->ctor_6();
}

// protected override sealed bool IsTriggered(bool on) :256
...
// public generated Selected New() :254
void Selected__New2_fn(Selected** __retval)
{
    *__retval = Selected::New2();
}

// public generated Selected() [instance] :254
void Selected::ctor_6()
{
    ctor_5();
}

// public generated Selected New() [static] :254
...
// public partial sealed class Selection :284
// {
// static Selection() :286
...
// private void Fuse.Scripting.IObserver.OnClear() :803
...
// private void Fuse.Scripting.IObserver.OnFailed(string message) :863
void Selection__FuseScriptingIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[5/*"/Users/malm...*/], 865, ::STRINGS[21/*"Fuse.Script...*/]);
}

// private void Fuse.Scripting.IObserver.OnInsertAt(int index, object value) :852
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 856, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }
...
// private void Fuse.Scripting.IObserver.OnNewAll(Fuse.Scripting.ListMirror values) :809
...
// private void Fuse.Scripting.IObserver.OnNewAt(int index, object newValue) :817
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 821, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }
...
// private void Fuse.Scripting.IObserver.OnRemoveAt(int index) :841
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 845, ::STRINGS[25/*"Fuse.Script...*/]);
        return;
    }
...
// private void Fuse.Scripting.IObserver.OnSet(object newValue) :828
...
// private void OnSelectionChanged(Fuse.Selection.Selection.How how) :730
void Selection__OnSelectionChanged_fn(Selection* __this, int* how)
{
    __this->OnSelectionChanged(*how);
}

// protected override sealed void OnUnrooted() :482
...
// public generated Selection() [instance] :284
...
// public void Add(Fuse.Selection.Selectable b) [instance] :583
...
// private void Add(string value) [instance] :699
...
// public void Clear() [instance] :603
...
// private void ClearSubscription() [instance] :794
...
// public void ForceAdd(Fuse.Selection.Selectable b) [instance] :612
...
// private void ForceAdd(string value) [instance] :617
...
// public void ForceRemove(Fuse.Selection.Selectable b) [instance] :629
...
// private void ForceRemove(string value) [instance] :634
...
// public bool get_HasMaxCount() [instance] :543
bool Selection::HasMaxCount()
{
    return _hasMaxCount;
}

// public bool IsSelected(Fuse.Selection.Selectable b) [instance] :551
...
// public int get_MaxCount() [instance] :521
int Selection::MaxCount()
{
    return _maxCount;
}

// public void set_MaxCount(int value) [instance] :522
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"MaxCount mu...*/], this, ::STRINGS[5/*"/Users/malm...*/], 529, ::STRINGS[29/*"set_MaxCount"*/]);
        return;
    }
...
// public int get_MinCount() [instance] :504
int Selection::MinCount()
{
    return _minCount;
}

// public void set_MinCount(int value) [instance] :505
...
// internal void ModifyValue(string old, string nw) [instance] :745
...
// private void OnObservableValuesChanged() [instance] :784
...
// private void OnSelectionChanged(Fuse.Selection.Selection.How how) [instance] :730
...
// public void Remove(Fuse.Selection.Selectable b) [instance] :593
...
// private void Remove(string value) [instance] :687
...
// public Fuse.Selection.SelectionReplace get_Replace() [instance] :494
int Selection::Replace()
{
    return _replace;
}

// public void set_Replace(Fuse.Selection.SelectionReplace value) [instance] :495
void Selection::Replace(int value)
{
    _replace = value;
}

// public int get_SelectedCount() [instance] :648
...
// public generated void add_SelectionChanged(Uno.EventHandler value) [instance] :722
...
// public generated void remove_SelectionChanged(Uno.EventHandler value) [instance] :722
...
// public void SetValue(string value, Uno.UX.IPropertyListener origin) [instance] :669
...
// public void Toggle(Fuse.Selection.Selectable b) [instance] :565
...
// private void Toggle(string value) [instance] :570
...
// public string get_Value() [instance] :663
...
// public void set_Value(string value) [instance] :667
...
// public object get_Values() [instance] :766
uObject* Selection::Values()
{
    return _observableValues;
}

// public void set_Values(object value) [instance] :767
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"`Values` mu...*/], this, ::STRINGS[5/*"/Users/malm...*/], 772, ::STRINGS[32/*"set_Values"*/]);
        return;
    }
...
// private static void add(Fuse.Scripting.Context c, Fuse.Selection.Selection s, object[] args) [static] :320
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"add require...*/], s, ::STRINGS[5/*"/Users/malm...*/], 324, ::STRINGS[1/*"add"*/]);
        return;
    }
...
// private static void clear(Fuse.Scripting.Context c, Fuse.Selection.Selection s, object[] args) [static] :302
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"clear requi...*/], s, ::STRINGS[5/*"/Users/malm...*/], 306, ::STRINGS[14/*"clear"*/]);
        return;
    }
...
// private static void forceAdd(Fuse.Scripting.Context c, Fuse.Selection.Selection s, object[] args) [static] :352
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"forceAdd re...*/], s, ::STRINGS[5/*"/Users/malm...*/], 356, ::STRINGS[15/*"forceAdd"*/]);
        return;
    }
...
// private static void forceRemove(Fuse.Scripting.Context c, Fuse.Selection.Selection s, object[] args) [static] :366
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"forceRemove...*/], s, ::STRINGS[5/*"/Users/malm...*/], 370, ::STRINGS[16/*"forceRemove"*/]);
        return;
    }
...
// public generated Selection New() [static] :284
...
// private static void remove(Fuse.Scripting.Context c, Fuse.Selection.Selection s, object[] args) [static] :338
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"remove requ...*/], s, ::STRINGS[5/*"/Users/malm...*/], 342, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
// private static void toggle(Fuse.Scripting.Context c, Fuse.Selection.Selection s, object[] args) [static] :382
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/malm...*/], 386, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
// internal static bool TryFindSelectable(Fuse.Node n, Fuse.Selection.Selectable& selectable, Fuse.Selection.Selection& selection) [static] :449
...
// internal static Fuse.Selection.Selection TryFindSelection(Fuse.Node v) [static] :432
...
// public abstract class SelectionEvent :204
// {
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 219, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
// internal SelectionEvent() [instance] :206
void SelectionEvent::ctor_5()
{
    ctor_4();
}

// private void OnSelectionChanged(object s, object args) [instance] :237
...
// public sealed class SelectionEventArgs :186
// {
...
// public SelectionEventArgs(string value) :193
void SelectionEventArgs__ctor_1_fn(SelectionEventArgs* __this, uString* value)
{
    __this->ctor_1(value);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :198
...
// public generated string get_Value() [instance] :191
uString* SelectionEventArgs::Value()
{
    return _Value;
}

// private generated void set_Value(string value) [instance] :191
void SelectionEventArgs::Value(uString* value)
{
    _Value = value;
}

// public SelectionEventArgs New(string value) [static] :193
...
// public enum SelectionReplace :406
...
// public sealed class ToggleSelection :909
// {
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 929, ::STRINGS[36/*"Perform"*/]);
        return;
    }
...
// public generated ToggleSelection() [instance] :909
void ToggleSelection::ctor_2()
{
    ctor_1();
}

// public Fuse.Selection.SelectMode get_Mode() [instance] :919
int ToggleSelection::Mode()
{
    return _mode;
}

// public void set_Mode(Fuse.Selection.SelectMode value) [instance] :920
void ToggleSelection::Mode(int value)
{
    _mode = value;
}

// public generated ToggleSelection New() [static] :909
...
// public sealed class WhileSelected :967
// {
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/malm...*/], 978, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }
...
// private void OnSelectionChanged(object s, object args) :1010
...
// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector prop) :1000
...
// public generated WhileSelected() [instance] :967
void WhileSelected::ctor_5()
{
    ctor_4();
}

// private void OnSelectionChanged(object s, object args) [instance] :1010
...
// public generated WhileSelected New() [static] :967
