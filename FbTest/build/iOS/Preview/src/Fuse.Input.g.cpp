...
// /Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/input/$.uno
// ------------------------------------------------------------------------------------------
...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/Users/malmgren/Library/Application Support/Fusetools/Packages/FuseCore/0.42.2/input/$.uno");
...
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Visual* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[9/*"HardCapture...*/], 1, ::STRINGS[10/*"/Users/malm...*/], 1191);
        return false;
    }
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[14/*"SoftCapture...*/], 1, ::STRINGS[10/*"/Users/malm...*/], 1100);
        return false;
    }
