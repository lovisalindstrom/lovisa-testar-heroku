...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("130.237.160.212"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "/Users/lovisalindstrom/Desktop/DSV/4. VT 2017/PVT/php:javascript/json_php_test/json_php_test.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("json_php_test");
}
}
}
